...
[ ![Download](https://api.bintray.com/packages/valkriaine/factor/bouncy/images/download.svg?version=1.4) ](https://bintray.com/valkriaine/factor/bouncy/1.4/link)
...
```
   dependencies {
        ...
        implementation 'com.factor:bouncy:1.4'
   }
 ```
